...
// Define the union type for the service IDs
type ServiceId = 'nursing' | 'physiotherapy' | 'postnatal' | 'babysitting';
...
  // Explicitly type the services array to use the ServiceId union
  const services: {
    id: ServiceId;
    name: string;
...
  // Ensure the function parameter is also of type ServiceId
